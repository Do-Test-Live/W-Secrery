...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 04, 2022 at 10:28 AM
...
(4, 'Frog Bid', 'frogbid.com', 'xyz.com', '', '0', '0', '0', '0', '', '', '', '', '', '', 0, '2022-12-04 11:35:45');
...
INSERT INTO `user` (`id`, `email`, `company_email`, `f_name`, `l_name`, `image`, `industry`, `position`, `c_domain_id`, `dob`, `gender`, `password`, `vcode`, `status`, `created_at`) VALUES
...
(3, 'test@gmail.com', 'test@companyname.com', 'Test', '3', '1.jpg', '2', 'Test Position', 1, '2022-11-01', 'Male', '$argon2id$v=19$m=65536,t=4,p=1$dFZoUVFaNTRVeXFvLkVpdw$mB9xOQ7jAtdu6Jj+ErZkpbcdssIzgTAJWTm0OJSptI0', 521287, 1, '2022-11-29 16:40:44');
