...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 23, 2022 at 12:09 PM
...
INSERT INTO `company_domain` (`id`, `company_name`, `domain_name`, `description`, `salary`, `hours`, `promotion`, `happiness`, `experience`, `monthly_income`, `location`, `working_hour`, `working_day`, `image`, `employee`, `created_at`) VALUES
...
INSERT INTO `user` (`id`, `email`, `f_name`, `l_name`, `image`, `industry`, `position`, `c_domain_id`, `dob`, `gender`, `password`, `vcode`, `status`, `created_at`) VALUES
(1, 'wing@101network.com', 'Wing', 'Chi', 'image-of-young-asian-businessman-with-glass-building-background-photo.jpg', '1', 'Account Manager', 1, '2000-02-08', 'Male', '$argon2id$v=19$m=65536,t=4,p=1$ckZGc21KUDlCQW4uc3poMw$oo6PNifTWKwQDezOWXYz2FkC4XX72dWfsbQNX9J8dGY', 652570, 1, '2022-11-23 16:25:04');
